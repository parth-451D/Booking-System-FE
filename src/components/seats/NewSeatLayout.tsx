...
const NewSeatLayout = () => {
  ...
  return (
    <>
      ...
      <div className="header flex justify-evenly bg-gray-200 content-center items-center h-16 flex-row ">
        ...
        <div className="flex flex-row w-[20%] justify-center items-center">
          ...
          <div
            ...
            className={`${
              seatsCount !== selectedSeatsArr.length
                ? "pointer-events-none"
                : ""
            } w-full`}
          >
      ...
      <div className="flex h-[100vh] w-full flex-row">
        <div className="left w-2/3 h-2/3 flex items-center flex-col">
          <div className="screen flex flex-col content-center mt-6 items-center">
            ...
            <div className="bg-gray-300 w-1/3  h-2 drop-shadow-2xl mb-4 flex justify-center border border-b-blue-400 shadow-blue-500 shadow-lg"></div>
            {numRows && (
              <div className="grid grid-rows-5 gap-4 mt-12">
      ...
      <div className="gap-6 flex h-full items-center justify-center flex-col"></div>
    </>
  );
};
